    ...
    <article class="w-64">
      ...
      <div class="bg-black rounded-b-lg px-4 flex flex-col items-center">
        <div class="w-full flex flex-col gap-y-1">
          <h3 class="text-white text-sm font-bold pt-2">{{ title }}</h3>
          <p class="text-white text-xs font-light">Prof. {{ teacher }}</p>
          <p class="text-white text-xs font-light flex gap-1">
          ...
          <div class="flex gap-1">
            <span class="text-white font-light text-xs">{{ rating }}</span>
            <div class="flex">
        ...
        <button class="bg-gradient-to-r from-[#FEE500] to-[#FD6A00] text-white py-1 px-3 rounded-md my-3 font-medium text-sm">Más información</button>
      </div>
    </article>
  `,
  styles: ``
