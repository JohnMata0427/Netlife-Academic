...
@Component({
  ...
  template: `
    <article class="w-64 shadow-md shadow-black/50 rounded-lg">
      ...
      <div class="bg-black rounded-b-lg px-4 py-3 flex flex-col gap-y-2">
        <h3 class="text-white text-sm text-center">
          Certificado de {{ title }}
        </h3>
        <div class="flex gap-x-4 justify-center relative">
          <app-custom-button
              ...
              <button class="size-full group">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 25">
                  <path
                    ...
                    class="fill-black group-hover:fill-[#FD6A00]"
                  />
                </svg>
              </button>
              <button class="size-full group">
    ...
    >
      <div class="flex flex-col items-end relative border border-[#FD6A00]">
        <svg
          xmlns="http://www.w3.org/2000/svg"
