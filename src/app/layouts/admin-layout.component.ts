          ...
          <ul class="flex flex-col gap-y-2 mt-6">
            <li>
              <button
                ...
                [ngClass]="{
                  'bg-white text-black': active === 'dashboard',
                  'bg-black text-white': active !== 'dashboard'
                }"
              ...
              >
                <svg width="18" viewBox="0 0 18 18">
                  <path
                    [ngClass]="{
                      'fill-black': active === 'dashboard',
                      'fill-white': active !== 'dashboard'
                    }"
                    id="Vector"
            ...
            <li>
              <button
                ...
                [ngClass]="{
                  'bg-white text-black': active === 'anuncios',
                  'bg-black text-white': active !== 'anuncios'
                }"
                class="rounded-xl py-2 px-4 flex gap-x-2 items-center text-sm w-full transition-all"
              >
                <svg width="17" height="20" viewBox="0 0 17 20">
                  <path
                    [ngClass]="{
                      'fill-black': active === 'anuncios',
                      'fill-white': active !== 'anuncios'
                    }"
                    id="Vector"
            ...
            <li>
              <button
                ...
                [ngClass]="{
                  'bg-white text-black': active === 'usuarios',
                  'bg-black text-white': active !== 'usuarios'
                }"
                class="rounded-xl py-2 px-4 flex gap-x-2 items-center text-sm w-full transition-all"
              >
                <svg width="20" height="20" viewBox="0 0 20 20">
                  <path
                    [ngClass]="{
                      'fill-black': active === 'usuarios',
                      'fill-white': active !== 'usuarios'
                    }"
                    id="Vector"
            ...
            <li>
              <button
                ...
                [ngClass]="{
                  'bg-white text-black': active === 'cursos',
                  'bg-black text-white': active !== 'cursos'
                }"
                class="rounded-xl py-2 px-4 flex gap-x-2 items-center text-sm w-full transition-all"
              >
                <svg width="17" height="20" viewBox="0 0 17 20">
                  <path
                    [ngClass]="{
                      'fill-black': active === 'cursos',
                      'fill-white': active !== 'cursos'
                    }"
                    id="Vector"
            ...
            <li>
              <button
                ...
                "
                [ngClass]="{
                  'bg-white text-black': active === 'certificados',
                  'bg-black text-white': active !== 'certificados'
                }"
                class="rounded-xl py-2 px-4 flex gap-x-2 items-center text-sm w-full transition-all"
              >
                <svg width="17" height="20" viewBox="0 0 17 20">
                  <path
                    [ngClass]="{
                      'fill-black': active === 'certificados',
                      'fill-white': active !== 'certificados'
                    }"
            ...
            <li>
              <button
                (click)="
                  router.navigate(['/admin/reportes']); active = 'Reportes'
                "
                [ngClass]="{
                  'bg-white text-black': active === 'reportes',
                  'bg-black text-white': active !== 'reportes'
                }"
                class="rounded-xl py-2 px-4 flex gap-x-2 items-center text-sm w-full transition-all"
              >
                <svg width="17" height="20" viewBox="0 0 17 20">
                  <path
                    [ngClass]="{
                      'fill-black': active === 'reportes',
                      'fill-white': active !== 'reportes'
                    }"
...
export class AdminLayoutComponent {
  ...
  constructor(private title: Title, private activatedRouter: ActivatedRoute) {
