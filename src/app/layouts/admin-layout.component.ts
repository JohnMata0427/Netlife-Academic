        ...
        <nav class="flex flex-col">
          ...
          <ul class="flex flex-col gap-y-2 mt-6">
            <li>
              ...
              >
                <svg class="z-10" width="18" height="18" viewBox="0 0 18 18">
                  <path
                    class="{{
                      active === 'dashboard'
            ...
            <li>
              <app-custom-button
                ...
                [moreStyles]="'w-full text-sm h-8 gap-x-2 group rounded-xl'"
              >
                <svg class="z-10" width="17" height="20" viewBox="0 0 17 20">
                  <path
                    class="{{
                      active === 'anuncios'
                        ? 'fill-black group-hover:fill-white'
            ...
            <li>
              <app-custom-button
                ...
                [moreStyles]="'w-full text-sm h-8 gap-x-2 group rounded-xl'"
              >
                <svg class="z-10" width="20" height="20" viewBox="0 0 20 20">
                  <path
                    class="{{
                      active === 'usuarios'
                        ? 'fill-black group-hover:fill-white'
